...
class Dobot:
    def __init__(self, port):
        ...
        self.interface.set_point_to_point_joint_params([100, 100, 100, 100], [100, 100, 100, 100]) # Geändert von 50 auf 100
        self.interface.set_point_to_point_coordinate_params(100, 100, 100, 100) # Geändert von 50 auf 100
        self.interface.set_point_to_point_common_params(100, 100) # Geändert von 50 auf 100
    ...
    def move_to(self, x, y, z, r, mode=3, wait=True):
