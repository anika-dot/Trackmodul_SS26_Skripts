...
######## INFO ########
# Comments at the end of script are original parser messages which have been changed in variable parsers
...
parsers = {
    ...
    62: [None, None, None, lambda x: list(struct.pack('<BB', *x))],
    ...
    138: [lambda x: None, None, lambda x: struct.unpack('<Q', bytearray(x))[0], lambda x: list(struct.pack('<B', *x))],
    # Calibration
